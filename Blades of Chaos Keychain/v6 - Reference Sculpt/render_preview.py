...
def render(item,width,height,paint=True,elevation=45,angle=-6):
    ...
    if paint:
        materials[item['material']==1]=[100,111,120,.48,0]
        materials[item['material']==2]=[68,63,52,.23,0]
        materials[item['material']==3]=[162,137,94,.44,0]
        materials[item['material']==4]=[184,189,187,.50,0]
        materials[item['material']==5]=[180,187,190,.60,0]
        materials[item['material']==6]=[68,59,42,.16,0]
...
def main():
    ...
    d.text((75,48),'REFERENCE SCULPT / v6',font=font(61,True),fill='#e1ded3')
    d.text((78,135),'110 mm  /  OPEN GUARD  /  PIERCED POMMEL  /  HELICAL GRIP',font=font(26),fill='#a0acad')
