#!/usr/bin/env python3
"""Slotted sensor plate — all dimensions in millimeters.
...
Uses the sensor manufacturer's mounting nuts. Printed slot diameter includes
...
ROOT2 = sqrt(2.0)
PRODUCT_ID = 'b2b_sensor_plate'
PRODUCT_TITLE = 'Slotted sensor plate'
