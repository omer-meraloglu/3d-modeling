#!/usr/bin/env python3
"""PCB inspection cradle — all dimensions in millimeters.
...
Prints two identical movable cradles. The board rests on its bottom edge.
...
BASE_LENGTH = 48.0     # Width across the PCB plane, for stability.
...
ROOT2 = sqrt(2.0)
PRODUCT_ID = 'b2b_pcb_cradle'
PRODUCT_TITLE = 'PCB inspection cradle'
