#!/usr/bin/env python3
"""Desk valet with divider — all dimensions in millimeters.
...
The removable divider uses 0.25 mm clearance on each slot face and end.
...
ROOT2 = sqrt(2.0)
PRODUCT_ID = 'b2c_divider_tray'
PRODUCT_TITLE = 'Desk valet with divider'
